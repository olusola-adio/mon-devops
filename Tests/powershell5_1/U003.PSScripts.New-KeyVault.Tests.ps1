...
Describe "New-KeyVault unit tests" -Tag "Unit" {
    ...
    Mock Get-AzureRmResourceGroup { return ConvertFrom-Json '{ "ResourceGroupName": "mon-foobar-rg", "Location": "westeurope" }' }
    ...
    It "Should not create anything if the key vault already exist" {
        Mock Get-AzureRmKeyVault { return ConvertFrom-Json '{ "VaultName": "mon-foobar-kv", "ResourceGroupName": "mon-foobar-rg", "Location": "westeurope" }' }
