...
An array of environment names.  Assumes that the MON naming convention for storage accounts is followed, ie <service><environment><project>str, eg monfooprojectbarstr
