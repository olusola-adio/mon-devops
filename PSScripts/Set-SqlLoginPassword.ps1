...
.EXAMPLE
Set-SqlLoginPassword -SQLServerName mon-foo-bar-sql -SQLDatabase mon-foo-bar-db -SQLAdminUsername sa -SQLAdminPassword password1 -SQLLogin connection_user -SQLLoginPassword abc123
