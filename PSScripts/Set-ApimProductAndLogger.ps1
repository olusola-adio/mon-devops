...
.EXAMPLE
Set-ApimProductAndLogger -ApimResourceGroup mon-foo-shared-rg -InstanceName mon-foo-shared-apim -ApiId barapi -ApiProductId bar-product -ApimLoggerName bar-logger
#>
[CmdletBinding()]
param(
